    ...
    <div>
      ...
      <section className="relative bg-[#4a1d24] text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-20 md:py-28 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">
            ...
            <span className="text-[#c9a84c]">bouteilles</span>
          </h1>
          <p className="text-lg md:text-xl text-white/70 mb-8 max-w-2xl mx-auto">
            La marketplace de confiance entre passionnés de vin. Achetez, vendez et découvrez des pépites directement entre particuliers.
          </p>
      ...
      <section className="bg-[#722f37] text-white">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-center gap-12 text-sm flex-wrap">
          ...
          <div className="flex items-center gap-2"><MessageSquare className="h-4 w-4 text-[#c9a84c]" /><span>Messagerie intégrée</span></div>
          <div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-[#c9a84c]" /><span>Particulier à particulier</span></div>
        </div>
      </section>
        ...
        <section>
          ...
          {listings && listings.length > 0 ? (
            ...
            <div className="text-center py-16 text-gray-400">
              ...
              <p className="text-lg font-medium text-gray-600">Soyez le premier à publier une annonce</p>
              <Link href="/annonces/nouvelle"
